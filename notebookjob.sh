...
singularity run --nv /proj/snic2019-8-171/nobackup/pharmbio-notebook-tf-2.1.0.simg bash -c "jupyter notebook --ip 0.0.0.0 --no-browser --NotebookApp.password='' --NotebookApp.token=''"
