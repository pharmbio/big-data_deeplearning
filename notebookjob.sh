#!/bin/sh
#SBATCH -A uppmax2021-2-3 -t 0:59:00 -p core -n 15 -M snowy --gres=gpu:t4:1 --parsable --reservation=uppmax2021-2-3_06
#CENV=${5-tf-gpu}
#CONTAINER=${6}

singularity run --nv /proj/uppmax2021-2-3/nobackup/pharmbio-notebook-tf-2.1.0.simg bash -c "jupyter notebook --ip 0.0.0.0 --port=8890 --no-browser --NotebookApp.default_url='/lab' --NotebookApp.password='' --NotebookApp.token=''"
